...
<body>
	<div id="interface">
		...
		<br>
		<hr>
		<form method="post" action="<?php echo base_url() ?>index.php/contas/delete">
			...
			<a href="<?php echo base_url() ?>/index.php/contas/read"><input type="button" value="Buscar"/></a>
			<a href="<?php echo base_url() ?>/index.php/contas/update"><input type="button" value="Atualizar"/></a>
			<a href="<?php echo base_url() ?>/index.php/contas/delete"><input type="submit" value="Apagar"/><h3>ou</h3><input type="reset" valeu="Limpar Campos">
			</fieldset></a>
	</div>
</body>
</html>